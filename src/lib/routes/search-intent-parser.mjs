...
const CITY_CATALOG = [
  ...
  { label: "马拉喀什", normalizedLabel: "marrakech", countryCode: "MA", aliases: ["马拉喀什", "马拉凯什", "marrakech", "marrakesh"], wikidataId: "Q101625" },
  { label: "菲斯", normalizedLabel: "fes", countryCode: "MA", aliases: ["菲斯", "非斯", "fes", "fez"], wikidataId: "Q80985" },
