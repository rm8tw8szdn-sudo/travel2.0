...
assert.deepEqual(reviewedClaimCatalogSummary().catalogIds.slice(0, 2), ["plannable-expansion-batch01", "plannable-expansion-batch02"]);
assert.equal(reviewedClaimCatalogSummary().catalogIds.includes("plannable-expansion-batch03"), true);
