...
const TRUSTED_SOURCE_DOMAINS = Object.freeze([
  ...
  { domain: "railway.am", sourceType: "official-transport-operator", publisher: "South Caucasus Railway" },
  { domain: "meteomonitoring.am", sourceType: "approved-high-trust-source", publisher: "Armenia Hydrometeorology and Monitoring Center" },
  { domain: "ady.az", sourceType: "official-transport-operator", publisher: "Azerbaijan Railways" },
  { domain: "meteo.az", sourceType: "approved-high-trust-source", publisher: "Azerbaijan National Hydrometeorological Service" },
  { domain: "zfbh.ba", sourceType: "official-transport-operator", publisher: "Railways of the Federation of Bosnia and Herzegovina" },
  { domain: "fhmzbih.gov.ba", sourceType: "approved-high-trust-source", publisher: "Federal Hydrometeorological Institute of Bosnia and Herzegovina" },
  { domain: "mzt.mk", sourceType: "official-transport-operator", publisher: "Railways Transport of North Macedonia" },
  { domain: "uhmr.gov.mk", sourceType: "approved-high-trust-source", publisher: "North Macedonia Hydrometeorological Service" },
  { domain: "railway.md", sourceType: "official-transport-operator", publisher: "Moldovan Railways" },
  { domain: "meteo.md", sourceType: "approved-high-trust-source", publisher: "Moldova State Hydrometeorological Service" },
  { domain: "cfl.lu", sourceType: "official-transport-operator", publisher: "CFL Luxembourg" },
  { domain: "meteolux.lu", sourceType: "approved-high-trust-source", publisher: "MeteoLux" },
  { domain: "ter.sncf.com", sourceType: "official-transport-operator", publisher: "SNCF TER" },
  { domain: "liemobil.li", sourceType: "official-transport-operator", publisher: "LIEmobil" },
  { domain: "mwasalat.om", sourceType: "official-transport-operator", publisher: "Mwasalat Oman" },
  { domain: "met.caa.gov.om", sourceType: "approved-high-trust-source", publisher: "Oman Civil Aviation Authority Meteorology" },
  { domain: "qr.com.qa", sourceType: "official-transport-operator", publisher: "Qatar Rail" },
  { domain: "qweather.gov.qa", sourceType: "approved-high-trust-source", publisher: "Qatar Meteorology Department" },
  { domain: "bahrainbus.bh", sourceType: "official-transport-operator", publisher: "Bahrain Public Transport Company" },
  { domain: "bahrainweather.gov.bh", sourceType: "approved-high-trust-source", publisher: "Bahrain Meteorological Directorate" },
  { domain: "kptc.com.kw", sourceType: "official-transport-operator", publisher: "Kuwait Public Transport Company" },
  { domain: "met.gov.kw", sourceType: "approved-high-trust-source", publisher: "Kuwait Meteorological Department" },
  { domain: "mot.gov.lb", sourceType: "government-transport-agency", publisher: "Lebanon Ministry of Public Works and Transport" },
  { domain: "meteo.gov.lb", sourceType: "approved-high-trust-source", publisher: "Lebanon Meteorological Service" },
  { domain: "intrant.gob.do", sourceType: "government-transport-agency", publisher: "Dominican Republic INTRANT" },
  { domain: "onamet.gob.do", sourceType: "approved-high-trust-source", publisher: "Dominican Republic ONAMET" },
  { domain: "knutsfordexpress.com", sourceType: "official-transport-operator", publisher: "Knutsford Express" },
  { domain: "metservice.gov.jm", sourceType: "approved-high-trust-source", publisher: "Meteorological Service of Jamaica" },
  { domain: "viazul.wetransp.com", sourceType: "official-transport-operator", publisher: "Viazul" },
  { domain: "insmet.cu", sourceType: "approved-high-trust-source", publisher: "Cuba Institute of Meteorology" },
  { domain: "bahamasair.com", sourceType: "official-transport-operator", publisher: "Bahamasair" },
  { domain: "met.gov.bs", sourceType: "approved-high-trust-source", publisher: "Bahamas Department of Meteorology" },
  { domain: "boa.bo", sourceType: "official-transport-operator", publisher: "Boliviana de Aviación" },
  { domain: "senamhi.gob.bo", sourceType: "approved-high-trust-source", publisher: "Bolivia SENAMHI" },
  { domain: "dinatran.gov.py", sourceType: "government-transport-agency", publisher: "Paraguay DINATRAN" },
  { domain: "meteorologia.gov.py", sourceType: "approved-high-trust-source", publisher: "Paraguay Directorate of Meteorology" },
  { domain: "mti.gob.ni", sourceType: "government-transport-agency", publisher: "Nicaragua Ministry of Transport and Infrastructure" },
  { domain: "ineter.gob.ni", sourceType: "approved-high-trust-source", publisher: "Nicaragua INETER" },
  { domain: "sntf.dz", sourceType: "official-transport-operator", publisher: "Algerian National Rail Transport Company" },
  { domain: "meteo.dz", sourceType: "approved-high-trust-source", publisher: "Algeria National Meteorological Office" },
  { domain: "grcl.gov.gh", sourceType: "official-transport-operator", publisher: "Ghana Railway Company" },
  { domain: "meteo.gov.gh", sourceType: "approved-high-trust-source", publisher: "Ghana Meteorological Agency" },
  { domain: "demdikk.sn", sourceType: "official-transport-operator", publisher: "Dakar Dem Dikk" },
  { domain: "anacim.sn", sourceType: "approved-high-trust-source", publisher: "Senegal ANACIM" },
  { domain: "ethiopianairlines.com", sourceType: "official-transport-operator", publisher: "Ethiopian Airlines" },
  { domain: "ethiomet.gov.et", sourceType: "approved-high-trust-source", publisher: "Ethiopian Meteorological Institute" },
  { domain: "transnamib.com.na", sourceType: "official-transport-operator", publisher: "TransNamib" },
  { domain: "meteona.com", sourceType: "approved-high-trust-source", publisher: "Namibia Meteorological Service" },
  { domain: "airbotswana.co.bw", sourceType: "official-transport-operator", publisher: "Air Botswana" },
  { domain: "gov.bw", sourceType: "approved-high-trust-source", publisher: "Botswana Department of Meteorological Services" },
  { domain: "madagascarairlines.com", sourceType: "official-transport-operator", publisher: "Madagascar Airlines" },
  { domain: "meteomadagascar.mg", sourceType: "approved-high-trust-source", publisher: "Madagascar Meteorological Service" },
  { domain: "mauritiusmetroexpress.mu", sourceType: "official-transport-operator", publisher: "Metro Express Mauritius" },
  { domain: "metservice.intnet.mu", sourceType: "approved-high-trust-source", publisher: "Mauritius Meteorological Services" },
  { domain: "bilet.railways.kz", sourceType: "official-transport-operator", publisher: "Kazakhstan Temir Zholy" },
  { domain: "kazhydromet.kz", sourceType: "approved-high-trust-source", publisher: "Kazhydromet" },
  { domain: "railway.uz", sourceType: "official-transport-operator", publisher: "Uzbekistan Railways" },
  { domain: "hydromet.uz", sourceType: "approved-high-trust-source", publisher: "Uzbekistan Hydrometeorological Service" },
  { domain: "kjd.kg", sourceType: "official-transport-operator", publisher: "Kyrgyz Railways" },
  { domain: "meteo.kg", sourceType: "approved-high-trust-source", publisher: "Kyrgyz Hydrometeorological Agency" },
  { domain: "railway.gov.bd", sourceType: "government-transport-agency", publisher: "Bangladesh Railway" },
  { domain: "bmd.gov.bd", sourceType: "approved-high-trust-source", publisher: "Bangladesh Meteorological Department" },
  { domain: "rsta.gov.bt", sourceType: "government-transport-agency", publisher: "Bhutan Road Safety and Transport Authority" },
  { domain: "nchm.gov.bt", sourceType: "approved-high-trust-source", publisher: "Bhutan National Center for Hydrology and Meteorology" },
  { domain: "pakrail.gov.pk", sourceType: "government-transport-agency", publisher: "Pakistan Railways" },
  { domain: "pmd.gov.pk", sourceType: "approved-high-trust-source", publisher: "Pakistan Meteorological Department" },
  { domain: "lcrc.ltd", sourceType: "official-transport-operator", publisher: "Laos-China Railway Company" },
  { domain: "dmhlao.etllao.com", sourceType: "approved-high-trust-source", publisher: "Lao Department of Meteorology and Hydrology" },
  { domain: "jpd.gov.bn", sourceType: "government-transport-agency", publisher: "Brunei Land Transport Department" },
  { domain: "met.gov.bn", sourceType: "approved-high-trust-source", publisher: "Brunei Darussalam Meteorological Department" },
  { domain: "cmairlines.com", sourceType: "official-transport-operator", publisher: "CM Airlines" },
  { domain: "copeco.gob.hn", sourceType: "approved-high-trust-source", publisher: "Honduras COPECO" },
  { domain: "vmt.gob.sv", sourceType: "government-transport-agency", publisher: "El Salvador Vice Ministry of Transport" },
  { domain: "snet.gob.sv", sourceType: "approved-high-trust-source", publisher: "El Salvador Environmental Observatory" },
  { domain: "samoashipping.com", sourceType: "official-transport-operator", publisher: "Samoa Shipping Corporation" },
  { domain: "samet.gov.ws", sourceType: "approved-high-trust-source", publisher: "Samoa Meteorology Division" },
  { domain: "airvanuatu.com", sourceType: "official-transport-operator", publisher: "Air Vanuatu" },
  { domain: "vmgd.gov.vu", sourceType: "approved-high-trust-source", publisher: "Vanuatu Meteorology and Geo-Hazards Department" },
  { domain: "transportboard.com", sourceType: "official-transport-operator", publisher: "Barbados Transport Board" },
  { domain: "barbadosweather.org", sourceType: "approved-high-trust-source", publisher: "Barbados Meteorological Services" },
  { domain: "nms.gov.bz", sourceType: "approved-high-trust-source", publisher: "National Meteorological Service of Belize" },
  { domain: "cvsky.cv", sourceType: "official-transport-operator", publisher: "CVSky" },
  { domain: "inmg.gov.cv", sourceType: "approved-high-trust-source", publisher: "Cabo Verde National Institute of Meteorology and Geophysics" },
  { domain: "discoverdominica.com", sourceType: "official-tourism-board", publisher: "Discover Dominica Authority" },
  { domain: "weather.ictu.gov.dm", sourceType: "approved-high-trust-source", publisher: "Dominica Meteorological Service" },
  { domain: "mnb.mn", sourceType: "approved-high-trust-source", publisher: "Mongolian National Broadcaster" },
  { domain: "namem.gov.mn", sourceType: "approved-high-trust-source", publisher: "Mongolia National Agency for Meteorology and Environmental Monitoring" },
  { domain: "rura.rw", sourceType: "government-transport-agency", publisher: "Rwanda Utilities Regulatory Authority" },
  { domain: "meteorwanda.gov.rw", sourceType: "approved-high-trust-source", publisher: "Rwanda Meteorology Agency" },
  { domain: "meteo.sc", sourceType: "approved-high-trust-source", publisher: "Seychelles Meteorological Authority" },
  { domain: "gov.sm", sourceType: "approved-high-trust-source", publisher: "Republic of San Marino" },
  { domain: "ptsc.co.tt", sourceType: "official-transport-operator", publisher: "Public Transport Service Corporation" },
  { domain: "metproducts.gov.tt", sourceType: "approved-high-trust-source", publisher: "Trinidad and Tobago Meteorological Service" },
  { domain: "mwe.go.ug", sourceType: "approved-high-trust-source", publisher: "Uganda Ministry of Water and Environment" },
  { domain: "zambia-airways.com", sourceType: "official-transport-operator", publisher: "Zambia Airways" },
  { domain: "zmd.gov.zm", sourceType: "approved-high-trust-source", publisher: "Zambia Meteorological Department" },
  { domain: "nrz.co.zw", sourceType: "official-transport-operator", publisher: "National Railways of Zimbabwe" },
  { domain: "weatherzw.org.zw", sourceType: "approved-high-trust-source", publisher: "Zimbabwe Meteorological Services Department" },
